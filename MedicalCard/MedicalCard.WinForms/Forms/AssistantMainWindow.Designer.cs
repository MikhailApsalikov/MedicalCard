...
{
	partial class AssistantMainWindow
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.currentAnalysisListView = new System.Windows.Forms.ListView();
			...
			// groupBox1
			// 
			this.groupBox1.Controls.Add(this.currentAnalysisListView);
			...
			this.groupBox1.Text = "Прием анализов:";
			// 
			// currentAnalysisListView
			// 
			this.currentAnalysisListView.Columns.AddRange(new System.Windows.Forms.ColumnHeader[] {
            this.columnId,
            this.columnHeader2,
            this.columnHeader3,
            this.columnHeader4});
			this.currentAnalysisListView.FullRowSelect = true;
			this.currentAnalysisListView.Location = new System.Drawing.Point(6, 42);
			this.currentAnalysisListView.MultiSelect = false;
			this.currentAnalysisListView.Name = "currentAnalysisListView";
			this.currentAnalysisListView.Size = new System.Drawing.Size(449, 386);
			this.currentAnalysisListView.TabIndex = 2;
			this.currentAnalysisListView.UseCompatibleStateImageBehavior = false;
			this.currentAnalysisListView.View = System.Windows.Forms.View.Details;
			this.currentAnalysisListView.DoubleClick += new System.EventHandler(this.currentDoubleClick);
			// 
			// columnId
			// 
		...
		private System.Windows.Forms.ListView currentAnalysisListView;
